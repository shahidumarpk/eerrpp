  	<div class="pull-left">
        <a class="navbar-brand" href="<?php echo SURL?>dashboard/dashboard">
  ...
  <div class="pull-right header-btns">
    ...
    <div class="btn-group user-menu">
      ...
      <button type="button" class="btn btn-sm dropdown-toggle padding-none" data-toggle="dropdown"> <img src="<?php echo ($this->session->userdata('customer_profile_image') == '') ? IMG."avatars/default_user.png" : SURL.'assets/customer_files/'.$this->session->userdata('customer_id')."/t1-".$this->session->userdata('customer_profile_image')?>" alt="user avatar" width="28" height="28" /> </button>
