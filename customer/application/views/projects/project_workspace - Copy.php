                        ...
                        <article class="row page">
                            <div class="mobile-full tablet-full desktop-8 desktop-push-2">
                                ...
                                <form action="#" class="demo_form">
                                    <div class="dropped" style="padding-top: 20px;"></div>
					  ...
					  <?php for($i=0; $i<$project_workspace_count; $i++) { ?>
                       ...
                       <div class="col-md-2">
                            ...
                            if($ext=='jpg' or $ext=='png') {?>
                             <a href="<?php echo MURL?>assets/project_attachments/<?php echo $project_workspace_arr[$i]['project_id']."/".$project_workspace_arr[$i]['attachments'] ?>" style="margin-left: -14px;width:136%;" data-toggle="lightbox" data-gallery="multiimages" data-title="<?php echo $project_workspace_arr[$i]['title'] ?>" class="col-sm-4">
                             
                             <img src="<?php echo MURL?>assets/project_attachments/<?php echo $project_workspace_arr[$i]['project_id']."/".$project_workspace_arr[$i]['attachments'] ?>" data-src="holder.js/100%x180" data-holder-rendered="false" style="width: 113px;">
                             </a>
