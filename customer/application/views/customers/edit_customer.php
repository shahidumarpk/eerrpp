        ...
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading">
              <div class="panel-title"> <span class="glyphicon glyphicon-book"></span>Edit</div>
               <ul class="nav panel-tabs">
                <li class="active"><a href="#user_prof_contents" data-toggle="tab">Edit Profile</a></li>
                <li class=""><a href="#upload_user_docs" data-toggle="tab">Upload</a></li>
              </ul>
            </div>
                  ...
                  <div id="user_prof_contents" class="tab-pane active">
                    ...
                    ?>
                     ...
                     <div class="form-group">
                        ...
                        <input id="username" name="username" type="text" class="form-control" placeholder="Enter Username" value="<?php echo stripslashes($customer_user_data['username']) ?>" required  readonly/>
                   ...
                   <div class="row form-group">
                        ...
                        <input type="hidden" name="customer_id" id="customer_id" value="<?php echo $this->session->userdata('customer_id'); ?>" readonly />
                    </div> 
                    </form>                  
                  </div>
...
<script>
$(document).ready(function() { $("#country_name").select2();});
$(document).ready(function() {$("#city_name").select2(); });
</script>
