            ...
            <div class="col-md-12">
              <div class="panel panel-visible">
                ...
                <div class="row">
					    ...
					    ?>
                          <a href="<?php echo SURL?>simple_slider/manage-slider/add-new-image"><span class="glyphicons glyphicons-circle_plus"></span> Add New</a>                        <?php  }  ?>
                        </div>
                    </div>  
                  ...
                  <table width="100%" height="121" class="table table-striped table-bordered table-hover" id="manage_slider_images">
                    <thead>
                      <tr>
                        ...
                        <th width="125" class="hidden-xs">Caption</th>
                        <th width="172" class="hidden-xs">Display Order</th>
					...
					?>
                            <tr>
                                ...
                                <td class="hidden-xs"><span class="xedit">
									<img src="<?php echo SIMPLE_SLIDER_IMAGES.'thumb/'.stripslashes($slider_images_arr[$i]['slider_image']) ?>" width="145" height="78"></span>
                                </td>
                                <td class="hidden-xs"><?php echo (stripslashes($slider_images_arr[$i]['slider_caption']) == '') ? '-' : stripslashes($slider_images_arr[$i]['slider_caption']); ?></td>
                                ...
                                <td class="hidden-xs"><?php echo date('d, M Y', strtotime($slider_images_arr[$i]['created_date'])) ?></td> 
                                ...
                                <td class="hidden-xs text-center">
									...
									?>
											<a href="<?php echo SURL?>simple_slider/manage-slider/edit-image/<?php echo $slider_images_arr[$i]['id']?>" type="button" class="btn btn-info btn-gradient" title="Edit Slider"> <span class="glyphicons glyphicons-edit"></span> </a>                                    
                                    <?php		
										}//end if 
                                        if($ALLOW_pages_delete == 1){ 
									?>
											<a href="<?php echo SURL?>simple_slider/manage-slider/delete-image/<?php echo $slider_images_arr[$i]['id']?>" type="button" class="btn btn-danger btn-gradient" onClick="return confirm('Are you sure you want to delete?')" title="Delete Slider"> <span class="glyphicons glyphicons-remove"></span> </a>                                    
                                    <?php	
										}//end if
                                    ?>
                                  </div>
