          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-visible">
                ...
                <div class="row">
                        <div class="col-md-10">
                            <div class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span>Employee Salary Report</div>
                        </div>
               ...
               <form class="cmxform" id="edit_admin_profile_frm" method="POST" action="<?php echo SURL?>admin/manage-user/salary-report" enctype="multipart/form-data"> 
                  ...
                  <table class="table table-striped table-bordered table-hover" id="manage_cms_pages">
                    <thead>
                      <tr>
                        ...
                        <th class="hidden-xs hidden-sm">Rating</th>
                         <th class="hidden-xs hidden-sm">Salary</th>
                    ...
                    <?php 
					 ...
					 for($i=0;$i<$admin_user_list_count;$i++){
						 ...
						 $total_salary +=  $admin_user_list[$i]['salary'];
                            ...
                            <tr>
                               ...
                               <?php  if($admin_user_list[$i]['is_awarded']==1){ ?><span class="label btn-success">Awarded</span>  <?php  } ?>
                                ...
                                <td class="hidden-xs hidden-sm"><b><?php echo round($admin_user_list[$i]['average_rating'],2); ?></b> </td>   
                                 ...
                                 <td class="hidden-xs"><?php if($admin_user_list[$i]['salary'] !=""){ echo number_format($admin_user_list[$i]['salary'],2,".",",");}else{echo "-";}?></td>
                              
                      
                               <td class="hidden-xs text-center">
                               
                                   <a href='' onClick='openModel("<?php echo $admin_user_list[$i]['id'] ?>")' id='emailTom' data-toggle='modal' data-target='#mailmodal' type='button' class='btn btn-info btn-gradient' title='Send Message'>Add Increament</a>
					...
					?>
                      ...
                      <tr>
                        ...
                        <th class="hidden-xs"></th>
                        <th class="hidden-xs hidden-sm"></th>
                         <th class="hidden-xs hidden-sm"><?php echo number_format($total_salary,2,".",","); ?></th>
                        <th class="hidden-xs hidden-sm" ></th>
                      </tr>
                    </tbody>
                  </table>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel">Add Increament</h4>
      </div>
      <div class="modal-body">
        <form action="<?php echo SURL?>admin/manage-user/add-increament" enctype="multipart/form-data" method="post">
         
                    <div class="form-group">
                        <label for="subject">Amount</label>
                        <input id="subject" name="amount" type="text" class="form-control"  value="" required/>
                      </div>
      ...
      <div class="modal-footer">
        ...
        <button id="submitMail" type="submit" class="btn btn-primary">Submit</button>
