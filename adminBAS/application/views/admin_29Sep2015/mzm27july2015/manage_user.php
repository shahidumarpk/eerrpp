					...
					?>
                            <tr>
                               ...
                               <td class="hidden-xs text-center">
								...
								?>
                                        <a href="<?php echo SURL?>admin/manage-user/view-attendance/<?php echo $admin_user_list[$i]['id'];?>" type='button' class='btn btn-info btn-gradient' title='View Attendance'> <span class='glyphicons glyphicons-eye_open'></span> </a>                                
                                <?php	
									}//end if
