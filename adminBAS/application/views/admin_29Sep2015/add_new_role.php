                      ...
                      <div class="section2">
                        <div class="form-group"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                          <label for="mobile_menu_<?php echo $c?>">
                          	<input type="checkbox" class="checkbox" id="mobile_menu_<?php echo $c?>" name="permission_arr[]" <?php echo ($main_menu['set_as_default'] == 1) ? 'checked' : ''?> value="<?php echo $main_menu_index?>"  />
                          	<?php echo $main_menu['menu_title']?> </label>
                          <?php 
										if(count($main_menu['sub_menu']) > 0){
							...
							?>
                                                  <div class="subsection2"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                                    ...
                                                    <label for="mobile_sub_menu_<?php echo $main_menu['sub_menu'][$j]['id']?>" style="font-weight:500">
                                                      <input type="checkbox" class="checkbox" id="mobile_sub_menu_<?php echo $main_menu['sub_menu'][$j]['id']?>" <?php echo ($main_menu['sub_menu'][$j]['set_as_default'] == 1) ? 'checked' : ''?> name="permission_arr[]" value="<?php echo $main_menu['sub_menu'][$j]['id']?>" />
                                                      <?php echo $main_menu['sub_menu'][$j]['menu_title']?> </label>
                                                  </div>
                          <?php			
											}//end for
