...
<br>
                ...
                <table class="table table-bordered" width="100%">
                  <thead>
                    <tr>
                      <th width="4%">#</th>
                      <th width="12%">Date</th>
                      <th width="28%">Detail</th>
                      <th width="15%">Income (PKR)</th>
                      <th width="14%">Income (USD)</th>
                      <th width="15%">Expense (PKR)</th>
                      <th width="12%">Expense (USD)</th>
              ...
              <?php if($projects_report_count >0){ 
					    ...
					    for($i=0; $i<$projects_report_count; $i++){	 
							...
							$total_income_usd+=$projects_report_data[$i]['income_usd'];
							$total_expense+=$projects_report_data[$i]['expense'];
							$total_expense_usd+=$projects_report_data[$i]['expense_usd'];
						  ?> 
                          
                           <tr>
                                <td><?php echo ($i+1);?></td>
                                <td><?php echo date('F j, Y', strtotime($projects_report_data[$i]['dated']));?></td>
                                <td><?php echo  stripslashes($projects_report_data[$i]['description']); ?></td>
                                <td><?php echo  number_format($projects_report_data[$i]['income'],2,".",",") ?></td>
                                 <td><?php echo  number_format($projects_report_data[$i]['income_usd'],2,".",",") ?></td>
                                <td><?php echo  number_format($projects_report_data[$i]['expense'],2,".",",") ?></td>
                                <td><?php echo  number_format($projects_report_data[$i]['expense_usd'],2,".",",") ?></td>
                       ...
                       <?php }//End for ?>
                           ...
                           <tr>
                                ...
                                <td><b><?php echo number_format($total_expense,2,".",",") ?></b></td>
                                <td><b><?php echo number_format($total_expense_usd,2,".",",") ?></b></td>
					  ...
					  <?php  }//End if ?>
                        ...
                        <tr>
                                ...
                                <td colspan="2" align="center"><b>PLS : <?php 
								
								$balance= $total_income- $total_expense;
								
								echo  number_format($balance,2,".",",")  ?> (PKR)</td>
                                <td></td>
