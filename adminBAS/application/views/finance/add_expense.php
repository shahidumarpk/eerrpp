        ...
        <div class="col-md-12"  style="min-height:1300px;">
          <div class="panel">
            <div class="panel-heading">
              <div class="panel-title"> <span class="glyphicon glyphicon-book"></span>Add Expense</div>
            </div>
            <div class="panel-body alerts-panel">
              <form class="cmxform" id="edit_admin_profile_frm" method="POST" action="<?php echo SURL?>finance/manage-financial_statistics/add_expense_process" enctype="multipart/form-data">
                <div class="tab-content border-none padding-none">
                  <div id="cms_main_contents" class="tab-pane active">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="row form-group">
                              ...
                              <div class="col-xs-4" id="todate">
                                   ...
                                   <input type="text" readonly style="cursor:pointer;" name="date" id="start_date" class="form-control" required /><span class="input-group-addon"><span id="targetto" onclick="create_date('todate')" class="glyphicon glyphicon-calendar" style="cursor:pointer;"></span></span>
	                          </div>
                              </div>
                      ...
                      <div class="form-group">
                        ...
                        <input id="usd" name="expense_usd" type="text" class="form-control"  value="" required style="width: 455px;"/>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input id="amount" name="expense_pkr" type="text" class="form-control"  value="" required style="width: 455px;" readonly/>
                      </div>
                    ...
                    <div class="form-group" align="right" style="margin-right:17px">
                        <input class="submit btn btn-blue" type="submit" name="add_expense_sbt" id="add_expense_sbt" value="Add Expense" />
                    </div>
