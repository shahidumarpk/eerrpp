              ...
              <?php if($expense_report_count >0){ 
					    ...
					    for($i=0; $i<$expense_report_count; $i++){	 
							  ...
							  $total_expenses+= $expense_report_data[$i]['expense'];
							   $total_expenses_usd+= $expense_report_data[$i]['expense_usd'];
						  ?> 
                          
                           <tr>
                                <td><?php echo ($i+1);?></td>
                                <td><?php echo date('d, M Y', strtotime($expense_report_data[$i]['dated']));?></td>
                                <td><?php echo  stripslashes($expense_report_data[$i]['description']); ?></td>
                                <td><?php echo  number_format($expense_report_data[$i]['expense'],2,".",",") ?></td>
                                 <td><?php echo  number_format($expense_report_data[$i]['expense_usd'],2,".",",") ?></td>
					  ...
					  ?>
                        ...
                        <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td><b><?php echo  number_format($total_expenses,2,".",",")?></b></td>
                                <td><b><?php echo  number_format($total_expenses_usd,2,".",",")?></b></td>
                                <td></td>
                                <td></td>
