            ...
            <div class="panel-body alerts-panel">
              <div class="row">
                    ...
                    <table class="table table-striped">
                          <tbody>
                            <tr>
                              ...
                              <td><?php echo $account_arr['title']; ?></td>
                            </tr>
                           
                            <tr>
                              <td><strong>Phone:</strong></td>
                              <td><?php echo $account_arr['phone']; ?></td>
                            </tr>
                            <tr>
                              <td><strong>Address:</strong></td>
                              <td><?php echo $account_arr['address']; ?></td>
                            </tr>
                            <tr>
                              <td><strong>City:</strong></td>
                              <td> <?php echo $account_arr['city_holders']; ?></td>
                            </tr>
                             <tr>
                              <td><strong>Created Date:</strong></td>
                              <td> <?php echo  date('d, M Y h:i:s a', strtotime($account_arr['created_date'])); ?></td>
                            </tr>
                             <tr>
                              <td><strong>Status:</strong></td>
                              <td> <?php if($account_arr['status']==1){ ?> Active <?php } ?><?php if($account_arr['status']==0){ ?> De-Active <?php } ?></td>
                            </tr>
                          </tbody>
                        </table>
                   ...
                   <div class="form-group" align="right" style="margin-right:17px">
                    	...
                    	<a class="submit btn btn-blue" href="<?php echo base_url().'cashs/manage-cashs'; ?>">Go Back</a>
                    </div>
