        ...
        <div class="col-md-12">
          <div class="panel">
            <div class="panel-heading">
              <div class="panel-title"> <span class="glyphicon glyphicon-book"></span> Edit Account </div>
              
            </div>
            <div class="panel-body alerts-panel">
              <form class="cmxform" id="add_new_slider_image_frm" method="POST" action="<?php echo SURL?>cashs/manage-cashs/edit-cash-process" enctype="multipart/form-data">
                <div class="tab-content border-none padding-none">
                  <div id="cms_main_contents" class="tab-pane active">
                    ...
                    <?php 
                        }//if($this->session->flashdata('ok_message')) $cashs_arr['branch_name'];
                    ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="title" id="title" value="<?php echo $cashs_arr['title'];  ?>" class="form-control" required>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="number" name="phone"  id="phone" value="<?php echo $cashs_arr['phone'];  ?>"  class="form-control" required>
                      </div>
                      
                       <div class="form-group">
                        <label for="title">Address</label>
                        <textarea class="form-control" id="address" name="address" rows="3" ><?php echo $cashs_arr['address'];  ?></textarea>
                      </div>
                        ...
                        <div class="col-md-5">
                          <label for="standard-list1">City</label>
                            <span id="city_response">
                                ...
                                <option><?php echo $cashs_arr['city_holders'];  ?></option>
                                <?php 
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-md-5">
                          <label for="standard-list1">Status</label>
                            ...
                            <option value="1" <?php if($cashs_arr['status']==1){ ?> selected <?php } ?>>Active</option>
                            <option value="0" <?php if($cashs_arr['status']==0){ ?> selected <?php } ?>>InActive</option>
                        </select>
                        </div>
                    </div>                      
                  </div>
                    ...
                    <input type="hidden" name="cash_id" value="<?php echo $cash_id; ?>" >
                    	<input class="submit btn btn-blue" type="submit" name="edit_branch" id="edit_branch" value="Edit Account" title="Click to Update Account" />
                    </div>
