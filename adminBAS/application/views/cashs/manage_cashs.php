            ...
            <div class="col-md-12">
              <div class="panel panel-visible">
                <div class="panel-heading">
                 ...
                 <div class="row">
                        <div class="col-md-4">
                           <div class="panel-title hidden-xs"> <span class="glyphicon glyphicon-list"></span>Manage Cash</div>
                        </div>
					    ...
					    ?>
                          <a href="<?php echo SURL?>cashs/manage-cashs/add-cash"><span class="glyphicons glyphicons-circle_plus"></span> Add New</a>                        <?php  }  ?>
                        </div>
                    </div>      
                ...
                ?>
                  ...
                  <table class="table table-striped table-bordered table-hover" id="manage_cash">
                    <thead>
                      <tr>
                       <th width="125" class="hidden-xs">Title</th>
                        <th width="125" class="hidden-xs">Phone</th>
                ...
                <div class="alert alert-danger alert-dismissable">
                	<strong>No Cash Record Found</strong> </div>                	
                <?php		
...
<script type="application/javascript">
	$('#manage_cash').dataTable({
		
		"bProcessing": true,
		"bServerSide": true,
		"sServerMethod": "POST",
		"sAjaxSource": "<?php echo base_url()?>cashs/manage-cashs/process-cash-grid",
