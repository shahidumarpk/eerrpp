        ...
        <div class="col-md-12" style="min-height:1280px;">
          <div class="panel">
            <div class="panel-heading">
              <div class="panel-title"> <span class="glyphicon glyphicon-book"></span> Add Cash In Account</div>
              
            </div>
            <div class="panel-body alerts-panel">
              <form class="cmxform" id="edit_admin_profile_frm" method="POST" action="<?php echo SURL?>cashs/manage-cashs/add-cash-in-process" enctype="multipart/form-data">
                  ...
                  <div id="cms_main_contents" class="tab-pane active">
                    ...
                    ?>
                       ...
                       <div class="row form-group">
                        <div class="col-md-5">
                          <label for="standard-list1">Select Cash Account</label>
                            <span id="city_response">
                            	<select style="width:100%;"  id="cash_account" name="cash_account" required>
                                <option value="">Select Account </option>
                                <?php 
									for($i=0;$i<$cashs_count;$i++){
								?>
									<option value="<?php echo $cashs_arr[$i]['id']?>"> <?php echo $cashs_arr[$i]['title']?></option>
                              <?php } ?>
                        		</select>
                        	</span>
                        </div>
                       ...
                       <div class="form-group">
                       <label for="upload">Upload Proof</label>
                      <input type="file" id="cash_proof_doc" name="cash_proof_doc" >
                    ...
                    <div class="form-group" align="right" style="margin-right:17px">
                    	<input class="submit btn btn-blue" type="submit" name="cashin" id="cashin" value="Add Cash-In" title="Click to Add Cash-In" />
                    </div>
