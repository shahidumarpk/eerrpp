                ...
                <div class="tab-content border-none padding-none">
                  <div id="cms_main_contents" class="tab-pane active">
                    ...
                    ?>
                      <div class="form-group">
                        ...
                        <input id="page_title" name="page_title" type="text" class="form-control" placeholder="Page Title" value="<?php echo stripslashes($page_data['page_title']) ?>" required/>
                      </div>
                      <div class="form-group">
                        <label for="page_short_desc">Short Description</label>
                        <textarea class="form-control" id="page_short_desc" name="page_short_desc" rows="3"><?php echo stripcslashes(strip_tags($page_data['page_short_desc'])) ?></textarea>
                      </div>
                      ...
                      <div class="form-group">
                        <textarea class="ckeditor editor1"  id="page_long_desc" name="page_long_desc" rows="14"><?php echo stripcslashes($page_data['page_long_desc']) ?></textarea>
                      </div>
                  ...
                  <div id="seo_contents" class="tab-pane">
                    ...
                    <div class="form-group" align="right" style="margin-right:17px">
                    	<input class="submit btn btn-blue" type="submit" name="upd_page_sbt" id="upd_page_sbt" value="Update Page"  title="Click to Update page"/>
