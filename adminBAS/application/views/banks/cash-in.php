        ...
        <div class="col-md-12" style="min-height:1280px;">
          <div class="panel">
            <div class="panel-heading">
              <div class="panel-title"> <span class="glyphicon glyphicon-book"></span> Deposit Amount</div>
              
            </div>
            <div class="panel-body alerts-panel">
              <form class="cmxform" id="add_new_slider_image_frm" method="POST" action="<?php echo SURL?>banks/manage-banks/add-cash-in-process" enctype="multipart/form-data">
                  ...
                  <div id="cms_main_contents" class="tab-pane active">
                    ...
                    ?>
                     ...
                     <div class="row form-group">
                      ...
                      <input type="file" id="bank_proof_doc" name="bank_proof_doc" >
                    ...
                    <div class="form-group" align="right" style="margin-right:17px">
                    	<input class="submit btn btn-blue" type="submit" name="cashin" id="cashin" value="Add Deposit" title="Click to deposit" />
                    </div>
