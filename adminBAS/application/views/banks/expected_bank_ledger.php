        ...
        <div class="col-md-12"  style="min-height:1300px;">
          <div class="panel">
            <div class="panel-heading">
              <div class="row">
                        <div class="col-md-10">
                           <div class="panel-title hidden-xs"> <span class="glyphicon glyphicon-list"></span>Bank Ledger <code class="btn-danger">Expected</code> </div>
                        </div>
           ...
           <form class="cmxform" id="edit_admin_profile_frm" method="POST" action="<?php echo SURL?>banks/manage-banks/expected-bank-ledger" enctype="multipart/form-data">     
              ...
              <?php if($projects_report_count >0){ 
					    ...
					    for($i=0; $i<$projects_report_count; $i++){	 
                          ...
                          <?php if ($projects_report_data[$i]['payment_confirm_status']==0) { ?>
                           <tr>
                                <td><?php echo ($i+1);?></td>
                                <td><?php echo date('M,d,Y', strtotime($projects_report_data[$i]['created_date']));?></td>
                                
                                <td><?php echo  $projects_report_data[$i]['description']; ?></td>
                                <td>
                                <?php if($projects_report_data[$i]['payment_proof'] !=""){?>
                                <a href="<?php  echo MURL."assets/payment_proof/".$projects_report_data[$i]['payment_proof']?>"  data-toggle="lightbox" data-gallery="multiimages" data-title="Payment Proof"><img style="width:160px;" src="<?php  echo MURL."assets/payment_proof/".$projects_report_data[$i]['payment_proof']?>"  data-holder-rendered="false"></a>
                              ...
                              <td><a title="Approve Payment" onClick="return confirm('Are you Sure want to approve this payment?')" class="btn btn-success btn-sm" href="<?php echo SURL?>banks/manage-banks/approve-ledger-payment/<?php echo $projects_report_data[$i]['id']; ?>" role="button">Approve Payment</a></td>
                           </tr>
                       <?php } ?>
                       <?php }//End for ?>
