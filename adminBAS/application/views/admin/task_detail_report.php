                  ...
                  <table class="table table-striped table-bordered table-hover" id="manage_cms_pages" width="100%">
                    <thead>
                      <tr>
                        ...
                        <th width="20%" class="hidden-xs hidden-sm" >Total Time</th>
					...
					?>
                          ...
                          <td class="hidden-xs"><?php echo $task_detail_report_arr[$i]['role_title'] ?></td>
							   ...
							   if($task_detail_report_arr[$i]['total_time'] !=""){
							   
							    if($task_detail_report_arr[$i]['total_time'] >=60){ 
								 
								  // $total_hours+= floor($task_detail_report_arr[$i]['total_time'] / 60);
								 
								   echo  $hours = floor($task_detail_report_arr[$i]['total_time'] / 60)." Hours";
								   
								 }else{
									 
									//$total_mints+= $task_detail_report_arr[$i]['total_time'];
									 
									echo  $task_detail_report_arr[$i]['total_time']." Mints";
