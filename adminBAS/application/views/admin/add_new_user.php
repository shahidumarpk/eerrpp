          ...
          <div class="panel">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group">
                        ...
                        <input id="father_name" name="father_name" type="text" class="form-control" placeholder="Enter Father Name" value="<?php echo $session_post_data['father_name'] ?>" required/>
                       </div>  
            ...
            <option value="<?php echo $countries_result_arr[$i]['iso']?>"><?php echo $countries_result_arr[$i]['country_name']?></option>    
                ...
                <div class="row form-group">
                              ...
                              <div id="starttime" class=" col-md-10 input-append">
                                <input data-format="hh:mm:ss" type="text" name="start_time" class="my-control" ></input>
                                <span class="add-on">
                   ...
                   <div class="form-group">
                        ...
                        <input id="designation" name="designation" type="text" class="form-control" placeholder="Enter Designation" value="<?php echo $session_post_data['designation'] ?>" required/>
                   </div> 
                   
                 <div class="form-group">
                    <label for="last_name">IP</label>
                    <input id="ip" name="ip" type="text" class="form-control" placeholder="Enter IP Address" 
                    value="<?php echo $session_post_data['ip'] ?>" required/>
                 </div>
                  
                  <div class="form-group">
                    <label for="last_name">PC No</label>
                    <input id="pc_no" name="pc_no" type="text" class="form-control" placeholder="Enter PC number" 
                    value="<?php echo $session_post_data['pc_no'] ?>" required/>
                  </div>
                   ...
                   <div class="form-group">
                    ...
                    value="<?php echo $session_post_data['desk_no'] ?>" required/>
                  </div>
