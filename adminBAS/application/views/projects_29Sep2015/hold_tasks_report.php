            ...
            <div class="col-md-12">
              <div class="panel panel-visible">
                <div class="panel-heading">
                 ...
                 <div class="row">
                        <div class="col-md-10">
                           <div class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span>Hold Tasks Report</div>
                        </div>
                ...
                <form class="cmxform" id="edit_admin_profile_frm" method="POST" action="<?php echo SURL?>projects/manage-projects/hold-tasks-report" enctype="multipart/form-data">     
