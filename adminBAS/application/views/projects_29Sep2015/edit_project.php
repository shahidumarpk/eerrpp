      ...
      <div class="row">
                       ...
                       <div class="col-md-6">
                        	<div class="row form-group">
                              ...
                              <div class="col-xs-5" id="todate">
                                   <div class="input-group"><input type="text"   readonly="readonly"  style="cursor:pointer;" name="start_date" id="start_date" class="form-control"  value="<?php echo date("m/d/Y", strtotime($project_detail_arr['start_date']));?>"/><span class="input-group-addon"><span id="targetto" onclick="create_date('todate')" class="glyphicon glyphicon-calendar" style="cursor:pointer;"></span></span>
	                        </div>
                            </div>
       ...
       <textarea class="form-control" id="project_detail" name="project_detail" rows="10"><?php echo stripcslashes(strip_tags($project_detail_arr['project_detail'])); ?></textarea>
          ...
          <select name="project_assign[]" id="project_assign" data-placeholder="Choose a name..." class="chosen-select" multiple style="width:350px;" tabindex="4">
			...
			if($users_list_arr[$i]['id'] != '1' && $users_list_arr[$i]['id'] != '2' && $users_list_arr[$i]['id'] != '3' && $users_list_arr[$i]['id'] != '4' && $users_list_arr[$i]['id'] != '9005'){	
			?>
