            ...
            <div class="col-md-12">
              <div class="panel panel-visible">
                <div class="panel-heading">
                 ...
                 <div class="row">
                        <div class="col-md-10">
                           <div class="panel-title"> <span class="glyphicon glyphicon-list-alt"></span>Start Tasks Report</div>
                        </div>
                ...
                <form class="cmxform" id="edit_admin_profile_frm" method="POST" action="<?php echo SURL?>projects/manage-projects/tasks-report" enctype="multipart/form-data">     
               ...
               <label class="hidden-sm " style="margin-right: -106px;">Search By Date :</label>
                ...
                ?>
                  ...
                  <table class="table table-striped table-bordered table-hover" id="manage_cms_pages">
                   ...
                   <td class="hidden-xs hidden-sm"><?php if($task_report_arr[$i]['status']==1)echo "Start";?>
                   								   <?php if($task_report_arr[$i]['status']==4)echo "Resume";?></td>     
                            </tr>
                    <?php			
						}//end for
					?>
