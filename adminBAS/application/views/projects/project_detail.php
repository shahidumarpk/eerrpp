        ...
        <div class="clear15"></div> 
                       ...
                       <input type="hidden" name="last_row_id" id="last_row_id" value="<?php echo $project_messages_arr[0]['id'];?>"  /> 
                        ...
                        <input class="submit btn btn-blue" name="reply_message_sbt" id="reply_message_sbt" type="submit" value="Reply" style="width:100%;" title="Click for Reply">
                         ...
                         <div>
         <input type="radio" value="0" checked="checked"  name="post_type">Internal </label>
         <input type="radio" value="1"  name="post_type"> External </label>
                 ...
                 <div class="tutorial_list">
                      <?php 
					//  echo"<pre>"; print_r($project_messages_arr); exit;
                        ...
                        <div class="well">
                        	<div class="row" >
                                <div class="col-md-2" style="border-right:1px solid #ccc;">
                                    ...
                                    <?php 
									if($project_messages_arr[$i]['avatar_image'] !=""){ ?>    
   ...
   <img src="<?php echo USER_FOLDER.'/'.$project_messages_arr[$i]['admin_id'].'/'.stripslashes($project_messages_arr[$i]['avatar_image'])?>">	
                                    ...
                                    <div class="text-small"> </div>
                                        ...
                                        <?php 
											...
											if($project_messages_arr[$i]['post_type'] == 1){
											
												echo "<strong> EXTERNAL </strong>";
											}else{
												echo"<strong> INTERNAL </strong>";
											}
										 ?>
                                        </div>
                                </div>
