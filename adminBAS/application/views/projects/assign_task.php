            ...
            <div class="panel-body alerts-panel">
              ...
              <?php  for($i=0; $i<count($team_arr); $i++) {?>
                ...
                <?php } ?>
                  ...
                  <span style="color: #d9534f;font-size: 12px;font-weight: 600;" id="error_user_id"></span>
                   ...
                   <div class="clearfix"></div>
                    ...
                    <div class="form-group" align="right" style="margin-right:17px">
                        <input class="submit btn btn-blue" type="submit" name="assing_task_sbt" id="assing_task_sbt" value="Assign Task" title="Click to Assign Task"  onclick="check_user();"/>
                    </div>
                </div>
