        ...
        <div class="col-md-12" style="min-height:1270px;">
          ...
          <select name="name[]" id="name" data-placeholder="Choose a name..." class="chosen-select" multiple style="width:350px;" tabindex="4">
            ...
            <?php  for($i=0; $i<$users_list_count; $i++) {?>
        			...
        			<?php if(!in_array($users_list_arr[$i]['id'],$assign_team_arr)){  ?>
                  <option value="<?php echo $users_list_arr[$i]['id'] ?>">
            			<?php echo $users_list_arr[$i]['first_name']." ".$users_list_arr[$i]['last_name']; ?>
                  </option>
              <?php } ?>
