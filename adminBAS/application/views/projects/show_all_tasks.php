            ...
            <div class="col-md-12" style="min-height:1300px;">
              <div class="panel panel-visible">
                ...
                ?>
                  ...
                  <table class="table table-striped table-bordered table-hover" id="manage_cms_pages">
                    ...
                    <?php 
						...
						for($i=0;$i<$all_tasks_count;$i++){
							...
							$total_allocatedtime+=$all_tasks_arr[$i]['allocatedtime'];
							$total_consumedtime+=$all_tasks_arr[$i]['consumedtime'];	
					...
					?>
                            <tr>
								...
								if($all_tasks_arr[$i]['allocatedtime'] !=0){ 
								 
								 if($all_tasks_arr[$i]['allocatedtime'] >=60){ 
								 
								   $hours = floor($all_tasks_arr[$i]['allocatedtime'] / 60);
								   $mints = ($all_tasks_arr[$i]['allocatedtime'] % 60);
									...
									echo  "00:".$all_tasks_arr[$i]['allocatedtime'];
							   ...
							   if($all_tasks_arr[$i]['task_started_date'] !="0000-00-00 00:00:00"){
							   ...
							   ?>
								...
								$consumedtime= $all_tasks_arr[$i]['consumedtime']; 
                  ...
                  <?php if($total_allocatedtime !="" or $total_consumedtime !="" ){ ?>
                  <table class="table table-striped table-bordered table-hover" id="manage_cms_pages">
                    <thead> 
                    <tr>
