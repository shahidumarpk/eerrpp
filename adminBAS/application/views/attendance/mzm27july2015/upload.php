        ...
        <div class="col-md-12">
          <div class="panel">
            ...
            <div class="panel-body alerts-panel">
                ...
                <form class="cmxform" id="add_frm" method="POST" action="<?php echo SURL?>attendance/manage-attendance/upload-process" enctype="multipart/form-data">  
                    ...
                    <div class="row form-group">
                        <div class="col-md-5">
                          <label for="standard-list1">User Name</label>
                           <select id="user_id" name="user_id" style="width:100%;" required>
                 ...
                 <div class="col-md-4">
                    <div class="row form-group">
                              ...
                              <div class="col-xs-4" id="todate">
                                   <div class="input-group"><input type="text" readonly style="cursor:pointer;" name="date" id="date" class="my-control" required /><span class="input-group-addon"><span id="targetto" onclick="create_date('todate')" class="glyphicon glyphicon-calendar" style="cursor:pointer;"></span></span>
	                        </div>
                            </div>
