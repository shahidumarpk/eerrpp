						 ...
						 ?>
                        	<tr>
                                ...
                                <td>
                                    ...
                                    <div class="post">  <?php  if($message_detail_arr[$i]['project_message'] !=""){ echo  stripcslashes($message_detail_arr[$i]['project_message']);}else{ echo  stripcslashes($message_detail_arr[$i]['message']);} ?><br>
