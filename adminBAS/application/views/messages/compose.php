        ...
        <div class="col-md-12" style="min-height:1300px;">
          <div class="panel">
            <div class="panel-heading">
              <div class="panel-title"> <span class="glyphicon glyphicon-book"></span> Compose New Message</div>
            </div>
            <div class="panel-body alerts-panel">
              <form class="cmxform" id="edit_admin_profile_frm" method="POST" action="<?php echo SURL?>messages/manage_messages/compose_process" enctype="multipart/form-data">
                <div class="tab-content border-none padding-none">
                  <div id="cms_main_contents" class="tab-pane active">
                   ...
                   <?php } ?>
                   <?php if($ALLOW_broadcast_to_branches==1){ ?>  
                   <div class="col-md-1" style="margin-top: 27px; font-weight:bold"> 
                    OR
                   </div>
                   <?php } ?>
            ...
            <?php }} ?>
                     ...
                     <div class="form-group">
                       <label for="page_title">Attach File </label>
						 <input type="file" id="attachment" name="attachment" title="Choose a file">
                  ...
                  <input type="hidden" name="message_id" value="<?php echo  $message_id; ?>" >
                    ...
                    <div class="form-group" align="right" style="margin-right:17px">
                        <input class="submit btn btn-blue" type="submit" name="send_message" id="send_message" value="Send Message" title="Click to Send Message" />
                    </div>
                </div>
