...
//echo $val['status'];1 3 1 2 3 2 1 2 1 3 1 3 1 1 1 1 1 1 3 1 2 1 2 2 2
                            ?>
            ...
            <span id="admin_id<?php echo $val['id']; ?>"  hidden="true"><?php echo $val['user_id']; ?></span>
                        ...
                        <td class="leave_modal" id="<?php echo $val['id']; ?>"><a href="#" class="btn btn-info btn-gradient btn-sm"><span class="glyphicons glyphicons-edit"></span></a></td>
                    </tr>
                     <?php } ?>
...
var showApproveButton = "<div class='container' id='showApproveButton' hidden><div class='row'><div class='col-md-12'><p>Are you sure you want to approve application?</p></div>";
    showApproveButton += "<form><div class='col-md-12'><p><input id='withpay' type='radio' name='leavetype_pay' value='1'><label for='withpay'>With Pay</label> <input id='withoutpay' type='radio' name='leavetype_pay' value='0'><label for='withoutpay'>Without Pay</label> </p></div></form>";
