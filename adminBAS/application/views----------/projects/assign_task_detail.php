             ...
             <?php
				if($assign_task_arr['rating_status'] !=1){
                  ...
                  if($ALLOW_task_approve == 1 && $assign_task_arr['status'] ==3 ){
					 ...
					 $task_end_date= $assign_task_arr['end_date']; 
				...
				?>
					  ...
					  <?php  echo $d." Days<br />";
						...
						?><strong><?php if($d<=0 and $h<=0 and $m<=0){echo "Before";}else{echo "After";} ?> Task End Date </strong></p>
                        <a href="<?php echo base_url()?>projects/manage-projects/approve-task-rating/<?php echo $assign_task_id;?>" type="button" class="btn btn-info btn-gradient" onClick="return confirm('Are you sure you want to  approve rating?')">Approve Rating</a>      
                         ...
                         <a href="<?php echo base_url()?>projects/manage-projects/not-approve-task-rating/<?php echo $assign_task_id;?>" onClick="return confirm('Are you sure you want to not approve rating?')" type="button" class="btn btn-danger btn-gradient" title="Delete Task">Rejected</a>    
