                  ...
                  <div class="row form-group">
                      ...
                      <div class="col-md-6">
                        	<div class="row form-group">
                              ...
                              <div class="col-xs-4" id="todate">
                                   <div class="input-group"><input type="text" readonly style="cursor:pointer;" name="start_date" id="start_date" class="form-control" required /><span class="input-group-addon"><span id="targetto" onclick="create_date('todate')" class="glyphicon glyphicon-calendar" style="cursor:pointer;"></span></span>
	                        </div>
                            </div>
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="form-group">
                        ...
                        <input id="live_url" name="live_url" type="text" class="form-control"  value="" />
                      </div>
                      
                       <div class="form-group">
                        <label for="local_url">Local URL</label>
                        <input id="local_url" name="local_url" type="text" class="form-control"  value="" />
                      </div>
