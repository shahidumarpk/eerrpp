        ...
        <div class="col-md-12" style="min-height:1100px;">
          <div class="panel">
            <div class="panel-heading">
              <div class="panel-title"> <span class="glyphicon glyphicon-book"></span> Add New Team</div>
            </div>
            <div class="panel-body alerts-panel">
              <form class="cmxform" id="add_new_user_frm" method="POST" action="<?php echo SURL?>team/manage-team/add-team-process" enctype="multipart/form-data">
                <div class="tab-content border-none padding-none">
                  <div id="cms_main_contents" class="tab-pane active">
                    ...
                    ?>
                     ...
                     <div class="form-group">
                        ...
                        <input id="team_title" name="team_title" type="text" class="form-control" value="<?php echo $session_post_data['first_name'] ?>" required/>
                      </div>
                          ...
                          <label for="standard-list1">Team Head </label>
                           ...
                           <option value="">Select team head Name</option>
								...
								for($c=0; $c < $admin_user_list_count ; $c++){ ?>
										<option value="<?php echo $admin_user_list[$c]['id'] ?>"><?php echo $admin_user_list[$c]['first_name']." ".$admin_user_list[$c]['last_name'];?></option>
								<?php }} ?>
                          </select>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                      ...
                      <select name="team_members[]" id="team_members" data-placeholder="Choose a name..." class="chosen-select" multiple style="width:350px;" tabindex="4">
                        ...
                        <option value="<?php echo $admin_user_list[$i]['id'] ?>"><?php echo $admin_user_list[$i]['first_name']." ".$admin_user_list[$i]['last_name']; ?></option>
				 ...
				 <br>
                    ...
                    <div class="form-group" align="right" style="margin-right:17px">
                        <input class="submit btn btn-blue" type="submit" name="add_new_team_sbt" id="add_new_team_sbt" value="Add New Team" />
                    </div>
                </div>
