        ...
        <div class="col-md-12"  style="min-height:1300px;">
          <div class="panel">
            <div class="panel-heading">
              <div class="panel-title"> <span class="glyphicon glyphicon-book"></span>Add Cash</div>
            </div>
            <div class="panel-body alerts-panel">
              <form class="cmxform" id="edit_admin_profile_frm" method="POST" action="<?php echo SURL?>finance/manage-financial_statistics/add_cash_process" enctype="multipart/form-data">
                  ...
                  <div id="cms_main_contents" class="tab-pane active">
                    ...
                    ?>
                       ...
                       <div class="row form-group">
                        <div class="col-md-5">
                          <label for="standard-list1">Forum </label>
                           <select id="e1" name="forum_id" style="width:100%;">
                           <option value="<?php echo $forum_arr[$c]['id'] ?>">Select Forum Name</option>
                                <?php 
                    ...
                    <div class="form-group" align="right" style="margin-right:17px">
                        <input class="submit btn btn-blue" type="submit" name="add_cash_sbt" id="add_cash_sbt" value="Add Cash" />
                    </div>
