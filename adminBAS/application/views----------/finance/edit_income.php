        ...
        <div class="col-md-12"  style="min-height:1300px;">
          <div class="panel">
            <div class="panel-heading">
              <div class="panel-title"> <span class="glyphicon glyphicon-book"></span>Edit Income</div>
            </div>
            <div class="panel-body alerts-panel">
              <form class="cmxform" id="edit_admin_profile_frm" method="POST" action="<?php echo SURL?>finance/manage-financial_statistics/edit_income_process" enctype="multipart/form-data">
                  ...
                  <div id="cms_main_contents" class="tab-pane active">
                    ...
                    ?>
                      ...
                      <div class="form-group">
                        ...
                        <input id="amount" name="amount" type="text" class="form-control"  value="<?php echo $income_arr['income']; ?>" required/>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="description" name="description" rows="10" ><?php echo $income_arr['description']; ?></textarea>
                      </div>
                    ...
                    <div class="form-group" align="right" style="margin-right:17px">
                        <input class="submit btn btn-blue" type="submit" name="edit_income_sbt" id="edit_income_sbt" value="Edit Income" />
                    </div>
