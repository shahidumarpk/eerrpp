            ...
            <div class="col-md-12">
              <div class="panel panel-visible">
                ...
                <div class="row">
					    ...
					    ?>
                          <a href="<?php echo SURL?>support/manage-tickets/add-ticket"><span class="glyphicons glyphicons-circle_plus"></span> Add New</a>                        <?php  }  ?>
                        </div>
                   </div> 
                ...
                ?>
                  ...
                  <table class="table table-striped table-bordered table-hover" id="manage_cms_pages">
                    ...
                    <?php 
							...
							if($ticket_list_result[$i]['first_name'] == "" && $ticket_list_result[$i]['last_name'] == ""){
								$name = 'Guest Customer';	
							}else{
					...
					?>
                            <tr>
                                ...
                                <td class="hidden-xs"><span class="xedit"><?php echo $ticket_number ;?></span></td>
                                
                   <td class="hidden-xs hidden-sm"><?php echo date('d, M Y', strtotime($ticket_list_result[$i]['created_date']) );?></td>
                   <td class="hidden-xs hidden-sm"><?php echo $name ; ?></td>
                   <td class="hidden-xs hidden-sm"><?php echo $ticket_list_result[$i]['subject'];?></td>
                   <td class="hidden-xs hidden-sm"><?php echo $ticket_status;?></td>
                ...
                <div class="alert alert-danger alert-dismissable">
                	<strong>No Ticket(s) Found</strong> </div>                	
                <?php		
					}//end if
				  ?>
                </div>
