                  ...
                  <table class="table table-striped table-bordered table-hover" id="manage_cms_pages">
					...
					?>
                            <tr>
                                ...
                                <td class="hidden-xs hidden-sm"><a class="anchor_style" href="<?php echo base_url()?>admin/manage-user/user-detail/<?php echo $messages_arr[$i]['id'] ?>" title="Click to User Detail" target="_blank"><?php echo $messages_arr[$i]['display_name'] ;?></a></td>
                                <td class="hidden-xs hidden-sm">
                              <?php if($messages_arr[$i]['unread_msg']!=0) { ?> 
                              
                             <a class="anchor_style" href="<?php echo SURL?>messages/manage-messages/message-inbox-detail/<?php echo $messages_arr[$i]['message_id']?>"><?php echo stripcslashes($messages_arr[$i]['subject']) ;?>
                             ...
                             <?php  } ?>
                                ...
                                <td class="hidden-xs hidden-sm"><?php echo date('d, M Y h:i:s a', strtotime($messages_arr[$i]['date']) );?></td>
                            </tr>
                    <?php			
						}//end for
					?>
       ...
       <?php    }//end if no unread messages ?>
         ...
         <div class="tab-content border-none padding-none">
                ...
                ?>
                  ...
                  <table class="table table-striped table-bordered table-hover" id="read_messages">
                    <thead>
                      <tr>
                       <th class="hidden-xs">#</th>
                        <th class="hidden-xs">From</th>
					...
					?>
                            <tr>
                                ...
                                <td class="hidden-xs hidden-sm"><a class="anchor_style" href="<?php echo base_url()?>admin/manage-user/user-detail/<?php echo $read_messages_arr[$i]['id'] ?>" title="Click to User Detail" target="_blank"><?php echo $read_messages_arr[$i]['display_name'] ;?></a></td>
                                <td class="hidden-xs hidden-sm">
                           <a  href="<?php echo SURL?>messages/manage-messages/message-inbox-detail/<?php echo $read_messages_arr[$i]['message_id']?>"><?php echo stripcslashes($read_messages_arr[$i]['subject']) ;?></a>
                              
                                
                                </td>
                                <td class="hidden-xs hidden-sm"><?php echo date('d, M Y h:i:s a', strtotime($read_messages_arr[$i]['date']) );?></td>
                            </tr>
                    <?php			
						}//end for
					?>
