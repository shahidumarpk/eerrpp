        ...
        <div class="col-md-12">
          <div class="panel">
            ...
            <div class="panel-body alerts-panel">
              <form class="cmxform" id="edit_template_frm" method="POST" action="<?php echo SURL?>invoices/manage-invoices/manage_template_process/" enctype="multipart/form-data">
					...
					*/	
                    ?>
                      ...
                      <div class="form-group">
                        ...
                        <div class="form-group">
                        <textarea class="ckeditor editor1"  id="template_body" name="template_body" rows="14"><?php echo $get_invoice_template_arr['template_body']; ?></textarea>
                      </div>
                      </div>
                    ...
                    <div class="row form-group">
                      ...
                      <input type="text" name="id" value="<?php echo $get_invoice_template_arr['id']; ?>" >
                    <div class="form-group" align="right" style="margin-right:17px">
                        <input class="submit btn btn-blue" type="submit" name="edit_email_template_sbt" id="edit_invoice_template_sbt" value="Edit Invoice Template" />
                    </div>
                </div>
