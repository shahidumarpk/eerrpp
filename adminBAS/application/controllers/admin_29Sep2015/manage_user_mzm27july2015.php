...
class Manage_User extends CI_Controller {
	...
	public function index(){
		...
		$data['ALLOW_user_view_attendance'] =   (in_array(138,$this->session->userdata('permissions_arr'))) ? 1 : 0;
	...
	public function view_attendance($user_id){
		...
		$get_user_attendance = $this->mod_admin->get_user_attendance($user_id);

		$data['attendance_arr'] = $get_user_attendance['final_arr'];
		$data['attendance_count'] = $get_user_attendance['attendance_count'];
